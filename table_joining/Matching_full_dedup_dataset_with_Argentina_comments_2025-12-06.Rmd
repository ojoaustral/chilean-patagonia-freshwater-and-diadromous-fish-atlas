...
Este documento describe el método empleado para reestablecer el vínculo uno-a-uno entre la tabla de comentarios y revisiones (table1) y la de la base de datos (table2) de modo de poder ejecutar dichos cambios, asegurando correspondencias precisas y completamente trazables.  
